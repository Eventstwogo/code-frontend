    ...
    <section className="w-full max-w-7xl mx-auto py-8 px-4">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {showViewAll && (
          <Link 
            href={viewAllLink} 
            className="bg-purple-100 text-purple-700 hover:bg-purple-200 px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 whitespace-nowrap"
          >
            View All Featured
          </Link>
        )}
      ...
      {showViewAll && (
        <div className="mt-8 text-center md:hidden">
          <Link 
            href={viewAllLink}
            className="inline-block bg-gradient-to-r from-purple-600 to-purple-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:from-purple-700 hover:to-purple-800 transform hover:scale-105 shadow-lg"
          >
