      ...
      try {
        ...
        if (eventTitle) {
          ...
          setFailureDetails({
            ...
            startTime: startTime || '',
            endTime: endTime || '',
            seatCategories: parsedSeatCategories.length > 0 ? parsedSeatCategories : [{
              seat_category_id: 'unknown',
              label: 'General',
              num_seats: parseInt(searchParams.get('numberOfTickets') || '1'),
              price_per_seat: parseFloat(searchParams.get('pricePerTicket') || '0'),
              total_price: parseFloat(searchParams.get('totalAmount') || '0'),
            }],
